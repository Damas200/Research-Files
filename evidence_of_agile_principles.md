# Evidence of Agile Principles

## 1. Agile Values Application

| Agile Value                | Evidence                                               |
| -------------------------- | ------------------------------------------------------ |
| Individuals & interactions | Daily self-reflection and structured sprint execution  |
| Working software           | Functional API in Sprint 1 and full system in Sprint 2 |
...
* Early delivery of working software (Sprint 1 API)
